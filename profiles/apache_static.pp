 ...
 */
class coralnexus::portal::profile::apache_static {
  ...
  corl::include { 'apache_site_classes':
    require => Class['coralnexus::portal::profile::apache_server']
  }

  #-----------------------------------------------------------------------------
  # Resources

  corl_resources('coralnexus::portal::profile::apache_static::git_site', 'apache::git_site', 'apache::git_site_defaults')
}

#-------------------------------------------------------------------------------
# Resource definitions

define coralnexus::portal::profile::apache_static::git_site (
  $domain                        = $name,
  $doc_root                      = undef,
  ...
  $apache_ssl_use_compression    = $apache::params::ssl_use_compression,
  ...
  apache::vhost::file { $name:
    ...
    ssl_use_compression    => $apache_ssl_use_compression,
